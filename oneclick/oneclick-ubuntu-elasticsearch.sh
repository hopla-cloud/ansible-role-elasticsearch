...
ansible-galaxy install hoplacloud.elasticsearch

# Write roles
echo "- hoplacloud.lamp (${currdate})" >> /etc/hopla.cloud-roles

# Install oneclick app
ansible-playbook /root/.ansible/roles/hoplacloud.elasticsearch/playbooks/hoplacloud_elasticsearch.yml --extra-vars "$1"
